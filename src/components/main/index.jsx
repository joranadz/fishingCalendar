        ...
        <main>
          ...
          <div className="card">
            <form className="form-group">
              ...
              />
              <p>Kur žvejojte</p>
              <input type="text" name={"kur"} onChange={this.formChange} />
              <p>Kokį naudojojote masalą</p>
              <input type="text" name={"koki"} onChange={this.formChange} />
              <p>Ką pagavote</p>
              <input type="text" name={"ka"} onChange={this.formChange} />
              <p>Kiek vientu ar kilogramu</p>
              <input type="number" name={"kiek"} onChange={this.formChange} />
              <br />
              <button className="btn btn-light">Issaugoti</button>
            </form>
          </div>
        </main>
      </React.Fragment>
